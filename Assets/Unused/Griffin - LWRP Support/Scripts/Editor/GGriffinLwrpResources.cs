...
{
    //[CreateAssetMenu(menuName = "Griffin/LWRP Resources")]
    public class GGriffinLwrpResources : ScriptableObject
    {
        private static GGriffinLwrpResources instance;
        public static GGriffinLwrpResources Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = Resources.Load<GGriffinLwrpResources>("GriffinLwrpResources");
                }
                return instance;
            }
        }
